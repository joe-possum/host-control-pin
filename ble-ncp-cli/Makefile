...
INCLUDEPATHS += \
-Iuart \
-Iprotocol/bluetooth/ble_stack/inc/common \
-Iprotocol/bluetooth/ble_stack/inc/host
...
ifeq ($(OS),posix)
C_SRC += uart/uart_posix.c
else ifeq ($(OS),win)
C_SRC += uart/uart_win.c
endif
...
# Library --- this is a very lazy approach,
# create library with all object in it, then 
# remove app.o
#
$(LIB_DIR)/$(PROJECTNAME).a : $(OBJS)
...
ifeq ($(filter $(MAKECMDGOALS),all debug release),)
	$(RMDIRS) $(OBJ_DIR) $(LST_DIR) $(EXE_DIR) $(LIB_DIR)
endif
